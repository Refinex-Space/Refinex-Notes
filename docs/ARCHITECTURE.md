...
- `src/components/ai/ChatPanel.tsx` now replaces the previous right-panel placeholder with a working AI conversation surface: provider/model selectors, message bubbles, Markdown rendering, streamed output cursor, stop-generation action, and history clearing all live inside the existing app shell.
