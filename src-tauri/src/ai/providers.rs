...
use crate::ai::{
    stream_sse_response, AIMessage, AIProvider, AIProviderConfig, AIProviderFuture, StreamControl,
    StreamOutcome, SseEvent, TokenEmitter,
};
...
mod tests {
    ...
    use crate::ai::{AIMessage, AIProviderConfig, AIProviderKind, SseEvent};
